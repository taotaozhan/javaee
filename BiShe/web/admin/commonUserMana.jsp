...
<div class="">
    <div class="pla1">
        <ol class="breadcrumb pla5" >
            <li><span class="glyphicon btn-xs glyphicon-align-justify"></span>网站用户管理</li>
            <li class="active">用户列表</li>
        </ol>
        <div class="Sum1">
            <form class="form-inline">
                <div class="form-group sum2" >
                    <label for="exampleInputName2" style="font-weight:normal;">手机号：</label>
                    <input type="text" class="form-control " id="exampleInputName2" >
                </div>
                <div class="form-group sum2">
                    <label for="exampleInputEmail2" style="font-weight:normal;">登录账号：</label>
        ...
        <div class="pla2">
            ...
            <a href="/admin/addEditCommonUser.jsp" style="color:black;">
                <div class="pla3"><span class="pla4 glyphicon glyphicon-plus"></span>添加用户</div>
            </a>
        </div>
        <div >
            <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <th style=" border-bottom: #dfdfdf 3px solid;">姓名</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">昵称</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">登录账号</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">手机号</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">性别</th>
                ...
                <tr>
                    ...
                    <td>已启用</td>
                    <td>
                        <a href="/admin/addEditCommonUser.jsp">
