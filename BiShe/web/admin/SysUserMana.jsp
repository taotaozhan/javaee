...
<div class="">
    <div class="pla1">
        ...
        <div class="Sum1">
            <form class="form-inline">
                <div class="form-group sum2" >
                    <label for="exampleInputName2" style="font-weight:normal;">账号：</label>
                    <input type="text" class="form-control " id="exampleInputName2" >
                </div>
                <div class="form-group sum2">
                    <label for="exampleInputEmail2" style="font-weight:normal;">姓名：</label>
        ...
        <div class="pla2">
            ...
            <a href="/admin/addEditSysPla.jsp" style="color:black;">
        ...
        <div >
            <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <th style=" border-bottom: #dfdfdf 3px solid;">登录密码</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">角色</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">姓名</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">性别</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">部门</th>
                ...
                <tr>
                    ...
                    <td>人事部</td>
                    <td>
                        <a href="/admin/addEditSysPla.jsp">
