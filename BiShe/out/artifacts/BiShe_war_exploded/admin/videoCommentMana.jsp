    ...
    <div class="pla1" >
        ...
        <div class="Sum1">
            <form class="form-inline">
                ...
                <div class="form-group sum2">
                    <label for="input1" style="font-weight:normal;">标题：</label>
                    <input type="email" class="form-control" id="input1">
                </div>
                <div class="form-group sum2">
                    <label for="input2" class="control-label">审核状态：</label>
                    <span class="dropdown" style="" id="input2" >
                        <button type="button" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">全部
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="#">已审核</a>
                            </li>
                            <li role="presentation">
                ...
                <button type="submit" class="btn btn-primary sum2" style="margin-left:15px;">查询</button>
            </form>
        </div>
        <div class="pla2">
            <div class="pla3"><span class="pla4 glyphicon glyphicon-trash"></span>批量删除</div>
            <div class="pla3" style="border: green 2px solid;"><span class="pla4 glyphicon glyphicon-check" style="color:green;"></span>批量审核</div>
        </div>
        <div style="height:390px;overflow:hidden;">
            <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <th style=" border-bottom: #dfdfdf 3px solid;">视频标题</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">内容</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">评论者</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">时间</th>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>口腔年会隆重召开</td>
                    <td><a href="/admin/commentContent.jsp">查看</a></td>
                    <td>app003</td>
                    <td>2017-11-08&nbsp;&nbsp;16:47:51</td>
                    <td><span class="notPass">未审核</span></td>
                    <td>
                        <div class="pla8"><span class="pla4 glyphicon glyphicon-trash"></span>删除</div>
                        <div class="pla3" style="border: green 2px solid;width:110px;margin-left:10px;margin-top:1px;">
                            <span class="pla4 glyphicon glyphicon-check" style="color:green;margin-left:-10px;"></span>审核通过
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>app003</td>
                    <td>2017-11-08&nbsp;&nbsp;16:47:51</td>
                    <td><span class="pass">已审核</span></td>
                    <td>
                        <div class="pla8"><span class="pla4 glyphicon glyphicon-trash"></span>删除</div>
                    </td>
                </tr>
