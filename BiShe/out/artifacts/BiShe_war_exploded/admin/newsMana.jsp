...
<div class="">
    <div class="pla1">
        ...
        <div class="sum1">
            <form class="form-inline">
                <div class="form-group sum2">
                    <label for="exampleInputEmail2" style="font-weight:normal;">标题：</label>
        ...
        <div class="pla2">
            ...
            <a href="/admin/addEditNews.jsp" style="color:black;">
                <div class="pla3" style="width:70px;"><span class="pla4 glyphicon glyphicon-plus"></span>添加</div>
            </a>
        </div>
        <div >
            <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <th style=" border-bottom: #dfdfdf 3px solid;">类型</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">状态</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">发布时间</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">发布者</th>
                    <th style=" border-bottom: #dfdfdf 3px solid;">详情信息</th>
                </tr>
                <tr>
                    ...
                    <td>userp_aaa</td>
                    <td><a href="/admin/addEditNews.jsp">查看</a></td>
                </tr>
                <tr>
                    <td><input type="checkbox" class="checkbox"></td>
                    <td>2</td>
